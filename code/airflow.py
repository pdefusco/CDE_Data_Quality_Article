...
batch_load_step = CDEJobRunOperator(
        ...
        dag=airflow_dag,
        job_name='batch-load-'+username+"-"+cde_demo, #Must match name of CDE Spark Job in the CDE Jobs UI
...
data_quality_step = CDEJobRunOperator(
        ...
        dag=airflow_dag,
        job_name='data-quality-'+username+"-"+cde_demo, #Must match name of CDE Spark Job in the CDE Jobs UI
        trigger_rule='all_success',
        )

start >> batch_load_step >> data_quality_step
